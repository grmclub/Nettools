...
#
#  taskset -c 4 tshark -r ITCH-pri.pcap -Tfields  -E separator=',' -e frame.time_epoch -e frame.len > plot.csv
#  taskset -c 5 ./itch_plotX.pl -f plot.csv -b > gplot.csv && ./plot_bytes.sh && eog out.png
#  taskset -c 5 ./itch_plotX.pl -f plot.csv -u > gplot2.csv && ./plot_bytes_us.sh && eog out.png
#
#Message counter
#  --does not count multiple msg's in a packet
#  taskset -c 4 tshark -r xx.pcap -Tfields  -E separator=',' -e frame.time_epoch -e itch.message_type > plot.csv
#  taskset -c 4 ./itch_plotX.pl -f plot.csv -m > gplot2.csv && ./plot_msg.sh && eog out.png
#
