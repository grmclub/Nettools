...
*  - Stores order ID, with order, but cannot be used in add/del as the book is of accumulating type
*
*/
...
void OrderBook::insert_order(Side o_side, long ord_no, double prc, int qty){
...
void OrderBook::delete_order(Side o_side, long ord_no, double prc, int qty){
...
void OrderBook::execute(long buy_ono, long sell_ono, double prc, int qty){
/*
...
/*
    ...
    for (int i=0; i< 5; ++i,j+=0.1){
        ob.insert_order(1301,Side_BID,order_no,j,1000);
        ob.insert_order(1301,Side_BID,order_no,j,1000);
    }
...
*/
    ...
    //Insert
    ob.insert_order(Side_BID,order_no,100.00,1000);++order_no;
    ob.insert_order(Side_BID,order_no,100.0,1000);++order_no;
    ob.insert_order(Side_BID,order_no,100.10,1000);++order_no;
    ob.insert_order(Side_BID,order_no,100.20,1000);++order_no;
    ob.insert_order(Side_BID,order_no,100.30,1000);++order_no;
    ob.insert_order(Side_BID,order_no,100.40,1000);++order_no;
    ob.insert_order(Side_BID,order_no,100.50,1000);++order_no;

    ob.insert_order(Side_ASK,order_no,100.60,1000);++order_no;
    ob.insert_order(Side_ASK,order_no,100.70,1000);++order_no;
    ob.insert_order(Side_ASK,order_no,100.80,1000);++order_no;
    ob.insert_order(Side_ASK,order_no,100.90,1000);++order_no;
    ob.insert_order(Side_ASK,order_no,100.90,1000);++order_no;
    ob.insert_order(Side_ASK,order_no,101.10,1000);++order_no;

    long dummy_ordNo =1;

    ob.print_book(ob);
    ob.delete_order(Side_BID,dummy_ordNo,100,1000);
    ob.delete_order(Side_BID,dummy_ordNo,100.1,1000);
    ob.delete_order(Side_ASK,dummy_ordNo,100.60,1000);

    ob.print_book(ob);
    //ob.insert_order(Side_ASK,100.90,1000);

    //Update Functionality
    ob.delete_order(Side_ASK,dummy_ordNo,100.90,2000);
    ob.insert_order(Side_ASK,order_no,100.50,3000);
