...
===============================================
1.  [Nmap Cheat Sheet Search](#nmap-cheat-sheet-search)
2.  [Target Specification](#target-specification)
3.  [Nmap Scan Techniques](#nmap-scan-techniques)
4.  [Host Discovery](#host-discovery)
5.  [Nmap Command Generator](#nmap-command-generator)
6.  [Port Specification](#port-specification)
7.  [Service and Version Detection](#service-and-version-detection)
8.  [OS Detection](#os-detection)
9.  [Timing and Performance](#timing-and-performance)
10.  [Timing and Performance Switches](#timing-and-performance-switches)
11.  [NSE Scripts](#nse-scripts)
12.  [Useful NSE Script Examples](#useful-nse-script-examples)
13.  [Firewall / IDS Evasion and Spoofing](#firewall-ids-evasion-and-spoofing)
14.  [Output](#output)
15.  [Helpful Nmap Output examples](#helpful-nmap-output-examples)
16.  [Miscellaneous Nmap Flags](#miscellaneous-nmap-flags)
17.  [Other Useful Nmap Commands](#other-useful-nmap-commands)
18.  [Frequently Asked Questions](#frequently-asked-questions)  
**Target Specification**
------------------------
Define exactly which [IPs, ranges, or subnets](https://www.stationx.net/how-to-use-nmap-to-scan-a-network/) Nmap should scan during your network reconnaissance.
**SWITCH**
**EXAMPLE**
**DESCRIPTION**
nmap 192.168.1.1
...
----------------------------
Choose the type of scan to run, from stealthy SYN scans to full TCP and [UDP scans](https://www.stationx.net/nmap-udp-scan/).
**SWITCH**
**EXAMPLE**
**DESCRIPTION**
\-sS
...
**Host Discovery**
------------------
[Identify which hosts are online](https://www.stationx.net/nmap-host-discovery/) before running a full scan or when skipping port scans entirely.
**SWITCH**
**EXAMPLE**
**DESCRIPTION**
\-sL
...
**OS Detection**
----------------
Use TCP/IP fingerprinting to [guess the operating system of target hosts](https://www.stationx.net/nmap-os-detection/).
**SWITCH**
**EXAMPLE**
**DESCRIPTION**
\-O
...
**NSE Scripts**
---------------
Enhance your scans with [Nmap’s scripting engine](https://www.stationx.net/nmap-scripting-engine/) for automation and deeper inspection.
**SWITCH**
**EXAMPLE**
**DESCRIPTION**
\-sC
...
------------------------------
Explore [specific NSE scripts](https://www.stationx.net/nmap-scripts/) for web scanning, brute forcing, [vulnerability scanning](https://www.stationx.net/nmap-vulnerability-scan/), or banner grabbing.
**COMMAND**
**DESCRIPTION**
